...
#define XEN_VIRTUAL_DISK_MAX_INDEX ((1 << 20) - 1)
#define XEN_VIRTUAL_DISK_NOMINAL_TYPE (202 << 8)
...
static int get_xvd_disk_id(const char *vname)
{
	...
	if (index > XEN_VIRTUAL_DISK_MAX_INDEX)
		return 0;

	return XEN_VIRTUAL_DISK_NOMINAL_TYPE | (index << 4) | part;
}
